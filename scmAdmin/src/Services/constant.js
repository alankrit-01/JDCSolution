...
export const Get_Retailer_By_Company = 'Get_Retailer_By_Company';
export const Set_Retailer_By_Company_List = 'Set_Retailer_By_Company_List';
export const Get_Factory = 'Get_Factory';
export const Get_Factory_By_Company = 'Get_Factory_By_Company';
...
export const Get_Factory_Local_Store_Data = 'Get_Factory_Local_Store_Data';
...
export const Check_Factory_Success_data = 'Check_Factory_Success_data';
