...
export const resetConpanyData = () =>{
    return{
        type:Reset_Conpany_Data
    } 
}
...
export const getCeoStatistics = (data) =>{
    return{
        type:Get_Ceo_Statistics,
        data:data 
    } 
}

export const getSuperAdminStatistics = (data) =>{
    return{
        type:Get_SuperAdmin_Statistics,
        data:data 
    } 
}
...
export const getAllReportForSuperAdmin = (data) =>{
    return{
        type:Get_All_Report_For_SuperAdmin,
        data:data 
    } 
}


export const getBatchProductForCeo = (data) =>{
    return{
        type:Get_Batch_Product_For_Ceo,
        data:data 
    } 
}
export const getBatchProductForSuperAdmin = (data) =>{
    return{
        type:Get_Batch_Product_For_SuperAdmin,
        data:data 
    } 
}
