            ...
            <div className="grid grid-cols-1 px-4 mb-16">
              ...
              <div className="flex flex-wrap">
                ...
                {allBatchProductdata && allBatchProductdata?.map((initialBatchProductdataVal) => <div className="w-full lg:w-6/12 pr-4 mb-10 font-light">
                  ...
                  <span onClick={() => navigate('/superAdmin/batchCoveredByCompany', { state: { factoryID: initialBatchProductdataVal?._id, factoryName: initialBatchProductdataVal?.name, factoryEmail: initialBatchProductdataVal?.email, factoryLocation: initialBatchProductdataVal?.city + " , " + initialBatchProductdataVal?.country, factoryPhone: initialBatchProductdataVal?.phone } })}>
