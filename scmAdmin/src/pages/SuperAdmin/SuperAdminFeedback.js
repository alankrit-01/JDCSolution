                            ...
                            <div className="flex flex-wrap feedback-padding">
                                ...
                                <div className="w-full lg:w-3/12 pl-4 mb-10 font-light">
                                    <div className="button-review">
                                        <NavLink to="/superAdmin/distributerFeedback" className="point-part">{distAverageRating.toFixed(1)}</NavLink>
                                        <NavLink to="/superAdmin/distributerFeedback" className="view-more-part">View more</NavLink>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-wrap feedback-padding">
                                ...
                                <div className="w-full lg:w-3/12 pl-4 mb-10 font-light">
                                    <div className="button-review">
                                        <NavLink to="/superAdmin/retailerFeedback" className="point-part">{retailerAverageRating.toFixed(1)}</NavLink>
                                        <NavLink to="/superAdmin/retailerFeedback" className="view-more-part">View more</NavLink>
                                    </div>
                                </div>
                            </div>
                            <div className="flex flex-wrap feedback-padding">
                                ...
                                <div className="w-full lg:w-3/12 pl-4 mb-10 font-light">
                                    <div className="button-review">
                                        <NavLink to="/superAdmin/customerFeedback" className="point-part">{custAverageRating.toFixed(1)}</NavLink>
                                        <NavLink to="/superAdmin/customerFeedback" className="view-more-part">View more</NavLink>
                                    </div>
                                </div>
                            </div>
                        </div>
