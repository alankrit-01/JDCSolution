              ...
              <div className="-mr-4 ml-6 profile-button custom-profile">
                <Dropdown
                  ...
                  buttonText={
                    <div className="w-24 profile-section">
                      ...
                      {initialdata?.superAdminUserName}
                    </div>
                  }
                  rounded
                  style={{
                ...
                >
                   <NavLink to="/admin/settings">
                    ...
                    <p className="nothing-part"> <span>{initialdata && initialdata?.superAdminUserName}</span></p>
            
                    <p className="click-open-btn"><Icon name="email" size="1xl" color="black" /> <a href="#">{initialdata && initialdata?.superAdminUserEmail}</a></p>
                    <p className="click-open-btn"><img src={locationicon} className="location-img" /> <a href="#">{initialdata && initialdata?.superAdminUserCity} , {initialdata && initialdata?.superAdminUserCountry}</a></p>
                    <p className="click-open-btn"><Icon name="phone" size="1xl" color="black" /> <a href="#">{initialdata && initialdata?.superAdminUserPhone}</a></p>
