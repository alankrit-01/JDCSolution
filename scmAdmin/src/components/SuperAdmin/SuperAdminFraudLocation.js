...
const SuperAdminFraudLocation = () => {
  ...
  const iconList = {
    ...
    icon3: 'https://cdn2.iconfinder.com/data/icons/IconsLandVistaMapMarkersIconsDemo/256/MapMarker_Marker_Outside_Chartreuse.png',
...
export default SuperAdminFraudLocation;